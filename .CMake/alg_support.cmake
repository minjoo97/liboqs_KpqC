...
if(CMAKE_SYSTEM_NAME MATCHES "Linux|Darwin")
if(OQS_DIST_X86_64_BUILD OR OQS_USE_AVX2_INSTRUCTIONS)
    cmake_dependent_option(OQS_ENABLE_SIG_haetae_2_avx2 "" ON "OQS_ENABLE_SIG_HAETAE" OFF)
    cmake_dependent_option(OQS_ENABLE_SIG_haetae_3_avx2 "" ON "OQS_ENABLE_SIG_HAETAE" OFF)
    cmake_dependent_option(OQS_ENABLE_SIG_haetae_5_avx2 "" ON "OQS_ENABLE_SIG_HAETAE" OFF)
endif()
endif()
...
if(CMAKE_SYSTEM_NAME MATCHES "Linux|Darwin")
  if(OQS_DIST_X86_64_BUILD OR OQS_USE_AVX2_INSTRUCTIONS)
    cmake_dependent_option(OQS_ENABLE_SIG_aimer_128s_avx2 "" ON "OQS_ENABLE_SIG_AIMER" OFF)
    cmake_dependent_option(OQS_ENABLE_SIG_aimer_128f_avx2 "" ON "OQS_ENABLE_SIG_AIMER" OFF)
    cmake_dependent_option(OQS_ENABLE_SIG_aimer_192s_avx2 "" ON "OQS_ENABLE_SIG_AIMER" OFF)
    cmake_dependent_option(OQS_ENABLE_SIG_aimer_192f_avx2 "" ON "OQS_ENABLE_SIG_AIMER" OFF)
    cmake_dependent_option(OQS_ENABLE_SIG_aimer_256s_avx2 "" ON "OQS_ENABLE_SIG_AIMER" OFF)
    cmake_dependent_option(OQS_ENABLE_SIG_aimer_256f_avx2 "" ON "OQS_ENABLE_SIG_AIMER" OFF)
endif()
endif()

option(OQS_ENABLE_KEM_SMAUG_T "Enable smaug_t algorithm family" ON)
cmake_dependent_option(OQS_ENABLE_KEM_smaug_timer "" ON "OQS_ENABLE_KEM_SMAUG_T" OFF)
cmake_dependent_option(OQS_ENABLE_KEM_smaug_t1 "" ON "OQS_ENABLE_KEM_SMAUG_T" OFF)
cmake_dependent_option(OQS_ENABLE_KEM_smaug_t3 "" ON "OQS_ENABLE_KEM_SMAUG_T" OFF)
cmake_dependent_option(OQS_ENABLE_KEM_smaug_t5 "" ON "OQS_ENABLE_KEM_SMAUG_T" OFF)

    if(CMAKE_SYSTEM_NAME MATCHES "Linux|Darwin")
    if(OQS_DIST_X86_64_BUILD OR OQS_USE_AVX2_INSTRUCTIONS)
        cmake_dependent_option(OQS_ENABLE_KEM_smaug_t1_avx2_kem "" ON "OQS_ENABLE_KEM_SMAUG_T" OFF)
        cmake_dependent_option(OQS_ENABLE_KEM_smaug_t3_avx2_kem "" ON "OQS_ENABLE_KEM_SMAUG_T" OFF)
        cmake_dependent_option(OQS_ENABLE_KEM_smaug_t5_avx2_kem "" ON "OQS_ENABLE_KEM_SMAUG_T" OFF)
        cmake_dependent_option(OQS_ENABLE_KEM_smaug_t1_avx2_kem90s "" ON "OQS_ENABLE_KEM_SMAUG_T" OFF)
        cmake_dependent_option(OQS_ENABLE_KEM_smaug_t3_avx2_kem90s "" ON "OQS_ENABLE_KEM_SMAUG_T" OFF)
        cmake_dependent_option(OQS_ENABLE_KEM_smaug_t5_avx2_kem90s "" ON "OQS_ENABLE_KEM_SMAUG_T" OFF)
    endif()
    endif()


option(OQS_ENABLE_KEM_NTRU_PLUS "Enable ntru plus algorithm family" ON)
cmake_dependent_option(OQS_ENABLE_KEM_ntru_plus_kem576 "" ON "OQS_ENABLE_KEM_NTRU_PLUS" OFF)
cmake_dependent_option(OQS_ENABLE_KEM_ntru_plus_kem768 "" ON "OQS_ENABLE_KEM_NTRU_PLUS" OFF)
cmake_dependent_option(OQS_ENABLE_KEM_ntru_plus_kem864 "" ON "OQS_ENABLE_KEM_NTRU_PLUS" OFF)
cmake_dependent_option(OQS_ENABLE_KEM_ntru_plus_kem1152 "" ON "OQS_ENABLE_KEM_NTRU_PLUS" OFF)

if(CMAKE_SYSTEM_NAME MATCHES "Linux|Darwin")
  if(OQS_DIST_X86_64_BUILD OR OQS_USE_AVX2_INSTRUCTIONS)
    cmake_dependent_option(OQS_ENABLE_KEM_ntru_plus_kem576_avx2 "" ON "OQS_ENABLE_KEM_NTRU_PLUS" OFF)
    cmake_dependent_option(OQS_ENABLE_KEM_ntru_plus_kem768_avx2 "" ON "OQS_ENABLE_KEM_NTRU_PLUS" OFF)
    cmake_dependent_option(OQS_ENABLE_KEM_ntru_plus_kem864_avx2 "" ON "OQS_ENABLE_KEM_NTRU_PLUS" OFF)
    cmake_dependent_option(OQS_ENABLE_KEM_ntru_plus_kem1152_avx2 "" ON "OQS_ENABLE_KEM_NTRU_PLUS" OFF)
endif()
endif()
...
elseif(${OQS_ALGS_ENABLED} STREQUAL "KpqC")
	filter_algs("SIG_haetae_2;SIG_haetae_3;SIG_haetae_5;SIG_aimer_128s;SIG_aimer_128f;SIG_aimer_192s;SIG_aimer_192f;SIG_aimer_256s;SIG_aimer_256f;KEM_smaug_timer;KEM_smaug_t1;KEM_smaug_t3;KEM_smaug_t5;KEM_ntru_plus_kem576;KEM_ntru_plus_kem768;KEM_ntru_plus_kem864;KEM_ntru_plus_kem1152;KEM_ntru_plus_pke576;KEM_ntru_plus_pke768;KEM_ntru_plus_pke864;KEM_ntru_plus_pke1152")
else()
...
if(CMAKE_SYSTEM_NAME MATCHES "Linux|Darwin")
if(OQS_DIST_X86_64_BUILD OR (OQS_USE_AVX2_INSTRUCTIONS))
    cmake_dependent_option(OQS_ENABLE_SIG_haetae_2_avx2 "" ON "OQS_ENABLE_SIG_haetae_2" OFF)
endif()
endif()

if(CMAKE_SYSTEM_NAME MATCHES "Linux|Darwin")
if(OQS_DIST_X86_64_BUILD OR (OQS_USE_AVX2_INSTRUCTIONS))
    cmake_dependent_option(OQS_ENABLE_SIG_haetae_3_avx2 "" ON "OQS_ENABLE_SIG_haetae_3" OFF)
endif()
endif()

if(CMAKE_SYSTEM_NAME MATCHES "Linux|Darwin")
if(OQS_DIST_X86_64_BUILD OR (OQS_USE_AVX2_INSTRUCTIONS))
    cmake_dependent_option(OQS_ENABLE_SIG_haetae_5_avx2 "" ON "OQS_ENABLE_SIG_haetae_5" OFF)
endif()
endif()
...
if(CMAKE_SYSTEM_NAME MATCHES "Linux|Darwin")
if(OQS_DIST_X86_64_BUILD OR (OQS_USE_AVX2_INSTRUCTIONS))
    cmake_dependent_option(OQS_ENABLE_SIG_aimer_128s_avx2 "" ON "OQS_ENABLE_SIG_aimer_128s" OFF)
endif()
endif()

if(CMAKE_SYSTEM_NAME MATCHES "Linux|Darwin")
if(OQS_DIST_X86_64_BUILD OR (OQS_USE_AVX2_INSTRUCTIONS))
    cmake_dependent_option(OQS_ENABLE_SIG_aimer_128f_avx2 "" ON "OQS_ENABLE_SIG_aimer_128f" OFF)
endif()
endif()

if(CMAKE_SYSTEM_NAME MATCHES "Linux|Darwin")
if(OQS_DIST_X86_64_BUILD OR (OQS_USE_AVX2_INSTRUCTIONS))
    cmake_dependent_option(OQS_ENABLE_SIG_aimer_192s_avx2 "" ON "OQS_ENABLE_SIG_aimer_192s" OFF)
endif()
endif()

if(CMAKE_SYSTEM_NAME MATCHES "Linux|Darwin")
if(OQS_DIST_X86_64_BUILD OR (OQS_USE_AVX2_INSTRUCTIONS))
    cmake_dependent_option(OQS_ENABLE_SIG_aimer_192f_avx2 "" ON "OQS_ENABLE_SIG_aimer_192f" OFF)
endif()
endif()

if(CMAKE_SYSTEM_NAME MATCHES "Linux|Darwin")
if(OQS_DIST_X86_64_BUILD OR (OQS_USE_AVX2_INSTRUCTIONS))
    cmake_dependent_option(OQS_ENABLE_SIG_aimer_256s_avx2 "" ON "OQS_ENABLE_SIG_aimer_256s" OFF)
endif()
endif()

if(CMAKE_SYSTEM_NAME MATCHES "Linux|Darwin")
if(OQS_DIST_X86_64_BUILD OR (OQS_USE_AVX2_INSTRUCTIONS))
    cmake_dependent_option(OQS_ENABLE_SIG_aimer_256f_avx2 "" ON "OQS_ENABLE_SIG_aimer_256f" OFF)
endif()
endif()
