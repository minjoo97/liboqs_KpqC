...
#define HAETAE_CRYPTO_PUBLICKEYBYTES (SEEDBYTES + K * POLYQ_PACKEDBYTES)                                      // seed + b
#if D == 1
#define HAETAE_CRYPTO_SECRETKEYBYTES (HAETAE_CRYPTO_PUBLICKEYBYTES + M * POLYETA_PACKEDBYTES + K * POLY2ETA_PACKEDBYTES + SEEDBYTES)  // pk + s + K
#elif D == 0
#define HAETAE_CRYPTO_SECRETKEYBYTES (HAETAE_CRYPTO_PUBLICKEYBYTES + (M + K) * POLYETA_PACKEDBYTES + SEEDBYTES)  // pk + s + K
#else
#error
#endif
#endif
