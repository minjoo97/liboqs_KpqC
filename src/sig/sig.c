...
OQS_API const char *OQS_SIG_alg_identifier(size_t i) {
	...
	const char *a[OQS_SIG_algs_length] = {
		...
		OQS_SIG_alg_haetae_2,
		OQS_SIG_alg_haetae_3,
		OQS_SIG_alg_haetae_5,
...
OQS_API int OQS_SIG_alg_is_enabled(const char *method_name) {
	...
	} else if (0 == strcasecmp(method_name, OQS_SIG_alg_haetae_2)) {
	...
	} else if (0 == strcasecmp(method_name, OQS_SIG_alg_haetae_3)) {
	...
	} else if (0 == strcasecmp(method_name, OQS_SIG_alg_haetae_5)) {
