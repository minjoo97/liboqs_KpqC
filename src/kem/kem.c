...
OQS_API const char *OQS_KEM_alg_identifier(size_t i) {
	...
	const char *a[OQS_KEM_algs_length] = {
		...
		OQS_KEM_alg_smaug_timer,
		OQS_KEM_alg_smaug_t1,
...
OQS_API int OQS_KEM_alg_is_enabled(const char *method_name) {
	if (method_name == NULL) {
		...
		return 0;
#endif
	} else if (0 == strcasecmp(method_name, OQS_KEM_alg_smaug_timer)) {
#ifdef OQS_ENABLE_KEM_smaug_timer
		return 1;
#else
		return 0;
#endif
	} else if (0 == strcasecmp(method_name, OQS_KEM_alg_smaug_t1)) {
#ifdef OQS_ENABLE_KEM_smaug_t1
		return 1;
#else
		return 0;
#endif
	} else if (0 == strcasecmp(method_name, OQS_KEM_alg_smaug_t3)) {
#ifdef OQS_ENABLE_KEM_smaug_t3
		return 1;
#else
		return 0;
#endif
	} else if (0 == strcasecmp(method_name, OQS_KEM_alg_smaug_t5)) {
		...
		return 0;
#endif
	} else if (0 == strcasecmp(method_name, OQS_KEM_alg_ntru_plus_kem864)) {
#ifdef OQS_ENABLE_KEM_ntru_plus_kem864
		return 1;
#else
		return 0;
#endif
	} else if (0 == strcasecmp(method_name, OQS_KEM_alg_ntru_plus_kem1152)) {
...
#ifdef OQS_ENABLE_KEM_smaug_timer
		return OQS_KEM_smaug_timer_new();
#else
		return NULL;
#endif
	}
...
#ifdef OQS_ENABLE_KEM_ntru_plus_kem768
		return OQS_KEM_ntru_plus_kem768_new();
#else
		return NULL;
#endif
	}
...
#ifdef OQS_ENABLE_KEM_ntru_plus_kem864
		return OQS_KEM_ntru_plus_kem864_new();
#else
		return NULL;
#endif
	}
...
#ifdef OQS_ENABLE_KEM_ntru_plus_kem1152
		return OQS_KEM_ntru_plus_kem1152_new();
#else
		return NULL;
#endif
	}
