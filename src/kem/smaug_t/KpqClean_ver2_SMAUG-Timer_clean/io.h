...
#define save_to_file TiMER_NAMESPACE(save_to_file)
...
#define load_from_file TiMER_NAMESPACE(load_from_file)
...
#define save_to_file_sk TiMER_NAMESPACE(save_to_file_sk)
...
#define load_from_file_sk TiMER_NAMESPACE(load_from_file_sk)
...
#define save_to_file_pk TiMER_NAMESPACE(save_to_file_pk)
...
#define load_from_file_pk TiMER_NAMESPACE(load_from_file_pk)
