...
#define crypto_kem_keypair cryptolab_smaug3_crypto_kem_keypair
#define crypto_kem_enc  cryptolab_smaug3_crypto_kem_encap
#define crypto_kem_dec cryptolab_smaug3_crypto_kem_decap
